...
@section('content')
    <div class="container py-5 col-md-12">
      <div class="row">
          ...
          <div class="card">
            <div class="card-header bg-defult">
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover table-responsive table-borderless" id="ServiceList">
                  <thead>
                    <tr>
                      <th>Title</th>
                      <th>Description</th>
        ...
        <div class="modal fade show" id="NewServiceModal" role="dialog">
        ...
        <div class="modal fade show" id="ShowServiceModal" role="dialog">
